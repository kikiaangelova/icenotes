...
const About: React.FC = () => {
  ...
  const copy = bg
    ? {
        eyebrow: 'За IceNotes',
        title: 'Написано на пейката до леда, между две тренировки.',
        intro:
          'IceNotes е тихо, лично място, в което да оставиш какво се е случило на леда днес — какво тръгна, какво заболя и какво искаш да опиташ утре.',
        storyEyebrow: 'Нашата история',
        storyTitle: 'Всичко започна с един лош ден на тренировка.',
        storyBody: [
          'Има един момент, който всеки фигурист познава: свалиш кънките, ръцете още треперят, а в главата ти се върти един и същи скок. Излизаш от пързалката и до вечерта вече не помниш какво точно се е объркало — помниш само, че е било тежко.',
          'Дъщеря ми е на 14 и от години кара фигурно. Един ден се прибра, седна на стълбите с кънките в ръце и каза: „Иска ми се да можех да си запиша това някъде, за да не го забравя до утре.“ Търсихме тетрадки, приложения за бележки, гласови съобщения до самата нея. Нищо не пасваше — всичко беше или прекалено сложно, или нямаше нищо общо със спорта.',
          ...
          'Днес IceNotes е за всяко момиче и момче, което излиза от пързалката с пълна глава. Няма оценки, няма класации, няма кой да ти каже, че не си се постарал(а) достатъчно. Само ти, ледът и това, което си научил(а) днес.',
        ],
        whyEyebrow: 'Защо главата е част от тренировката',
        whyTitle: 'Фигурното не се кара само с крака.',
        whyBody:
          'Един и същи скок излиза на тренировка и не излиза на състезание. Разликата рядко е в техниката — по-често е в напрежението, страха от падане и мислите секунда преди захода. Това също се тренира, само че никой не ти го показва.',
        ...
        helps: [
          { h: 'Рефлексия след лед', p: 'Три минути, в които подреждаш какво стана.' },
          { h: 'Запис на тренировката', p: 'Какво кара, колко време и как ти беше.' },
