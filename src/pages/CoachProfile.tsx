  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      <Navbar isDarkMode={isDarkMode} onToggleDarkMode={() => setIsDarkMode(!isDarkMode)} />
        <Seo title="Coach Kiki – AI Sport-Psychology Mentor for Skaters" description="Meet Coach Kiki, the warm AI mentor inside SkateGoals that guides figure skaters through reflection, technique cues, and pre-competition prep." path="/coach-profile" jsonLd={{"@context": "https://schema.org", "@type": "Person", "name": "Coach Kiki", "jobTitle": "AI Sport-Psychology Coach for Figure Skaters", "description": "Warm mentor and hype coach inside SkateGoals, guiding skaters through reflection, mental resilience, visualization, and competition prep.", "url": "https://skategoals.com/coach-profile"}} />
