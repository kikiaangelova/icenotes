...
const dict: Dict = {
  ...
  // ───── Benefits ─────
  'benefit.mind.title': { en: 'A softer mind', bg: 'По-меко съзнание' },
  'benefit.mind.text': { en: 'Some days the ice is loud. Find a quieter place to land.', bg: 'Има дни, в които ледът е шумен. Намери по-тихо място, в което да кацнеш.' },
  'benefit.training.title': { en: 'Practice that means something', bg: 'Тренировки, които значат нещо' },
  'benefit.training.text': { en: 'Write down what mattered today. Even the falls.', bg: 'Запиши какво беше важно днес. Дори паданията.' },
  'benefit.growth.title': { en: 'Proof you\'re growing', bg: 'Доказателство, че растеш' },
  'benefit.growth.text': { en: 'Look back in a month and feel how far you\'ve come.', bg: 'Погледни назад след месец и усети колко път си изминала.' },

  // ───── Social proof + steps + final CTA ─────
  'social.text': { en: 'Skaters who feel everything — finally have somewhere to put it. ⛸️', bg: 'Фигуристи, които усещат всичко — най-сетне имат къде да го оставят. ⛸️' },
  'social.cta': { en: 'Find your space', bg: 'Намери своето място' },
  'steps.heading': { en: 'Three small things. Big shift.', bg: 'Три малки неща. Голяма промяна.' },
  'steps.train.title': { en: 'Skate', bg: 'Пързаляй се' },
  'steps.train.text': { en: 'Live your session — on or off the ice.', bg: 'Изживей тренировката си — на лед или извън него.' },
  ...
  'steps.grow.text': { en: 'Notice the skater you\'re becoming.', bg: 'Забележи каква фигуристка ставаш.' },
  'finalCta.heading': { en: 'There\'s a quieter way to skate.', bg: 'Има по-тих начин да се пързаляш.' },
  'finalCta.subtitle.before': { en: 'Free, private, and made with', bg: 'Безплатно, поверително и създадено с' },
  ...
  // ───── Footer ─────
  'footer.tagline': { en: 'A safe space for skaters to reflect, train, and grow — together.', bg: 'Безопасно пространство, в което фигуристите рефлектират, тренират и растат — заедно.' },
  ...
  'footer.signup': { en: 'Join free', bg: 'Започни безплатно' },
  ...
  'footer.builtWith': { en: 'Made with', bg: 'Създадено с' },
  'footer.forSkaters': { en: 'for the next generation of skaters.', bg: 'за следващото поколение фигуристи.' },
