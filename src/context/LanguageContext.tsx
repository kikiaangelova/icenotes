...
const dict: Dict = {
  ...
  'steps.train.text': { en: 'Live your session — on or off the ice.', bg: 'Изживей тренировката — на лед или извън.' },
  'steps.reflect.title': { en: 'Breathe it out', bg: 'Издишай' },
  'steps.reflect.text': { en: 'Five quiet minutes. Whatever comes up.', bg: 'Пет тихи минути. Каквото изплува.' },
  'steps.grow.title': { en: 'Come home to yourself', bg: 'Върни се при себе си' },
  'steps.grow.text': { en: 'Notice the skater you\'re becoming.', bg: 'Забележи в какъв фигурист се превръщаш.' },
  ...
  'land.sub': {
    ...
    bg: 'Записваш как наистина е минала тренировката — скоковете, нервите, добрите прокарвания. Coach Kiki го чете и ти връща един въпрос.',
  },
  ...
  'land.inside.titleAccent': { en: 'A training log with a sport psychologist in it.', bg: 'Дневник за тренировки със спортен психолог вътре.' },
  'land.inside.sub': {
    en: 'Goals, session notes, jumps, mood — and Coach Kiki asking what a good psychologist would ask.',
    bg: 'Цели, бележки от тренировката, скокове, настроение — и Coach Kiki, който пита това, което добър психолог би попитал.',
  },
  ...
  'journal.workedOn.placeholder': { en: 'Jumps, spins, edges, just skating around…', bg: 'Скокове, пирети, кантове, просто каране…' },
  ...
  'training.subheading': { en: 'Track your training across all disciplines', bg: 'Следи всичко — на лед, извън лед и в главата' },
  ...
  'training.offIce.title': { en: 'Off-Ice Training', bg: 'Извън лед' },
  ...
  'training.onIce.edges': { en: 'Edge work & stroking', bg: 'Кантове и базово каране' },
  ...
  'training.onIce.moves': { en: 'Moves in the Field', bg: 'Moves in the Field' },
  ...
  'about.title': { en: 'Built by a 14-year-old figure skater, for figure skaters.', bg: 'Направено от 14-годишна фигуристка — за фигуристи.' },
  'about.subtitle': { en: 'A private space to reflect, train intentionally, and grow — on and off the ice.', bg: 'Лично място, в което си записваш, тренираш с цел и растеш — на лед и извън него.' },
  'about.story.title': { en: 'Our Story', bg: 'Историята накратко' },
  'about.story.lead': { en: 'Created by a young figure skater and her mom who saw a gap: skaters often struggle not from lack of talent, but lack of tools.', bg: 'Започна просто — една млада фигуристка искаше начин да си записва тренировките и да следи как се развива. Мама ѝ помогна да го направят като приложение. Без драма, без големи думи — просто инструмент, какъвто им липсваше.' },
  'about.story.b1': { en: 'Reflect after every session', bg: 'Запис след всяка тренировка' },
  'about.story.b2': { en: 'Track progress over time', bg: 'Ясен поглед върху прогреса' },
  'about.story.b3': { en: 'Build mental resilience', bg: 'По-силна глава за състезания' },
  ...
  'features.f5.desc': { en: 'Detailed session logging for edges, spins, footwork, and programs. Track duration, activities, and how each session felt.', bg: 'Подробен запис на тренировки — кантове, пирети, стъпки, програми. Време, активности и усещане.' },
  'features.f6.title': { en: 'Off-Ice Training Log', bg: 'Дневник извън лед' },
  'features.f6.desc': { en: 'Log strength, flexibility, and conditioning work. Keep your off-ice preparation as structured as your time on the ice.', bg: 'Сила, гъвкавост, кондиция. Извън лед е също толкова важно, колкото на лед.' },
  'features.f7.title': { en: 'Weekly Goals', bg: 'Седмични цели' },
  'features.f7.desc': { en: 'Set targets for on-ice hours, off-ice sessions, and specific jump attempts each week. Stay intentional about your development.', bg: 'Цели за часове на лед, тренировки извън и конкретни скокове всяка седмица. Тренирай с цел.' },
  ...
  'contact.form.emailPh': { en: 'you@example.com', bg: 'ti@example.com' },
  ...
  'psy.title': { en: 'Train your mind like your body.', bg: 'Тренирай главата, както тренираш тялото.' },
  'psy.subtitle': { en: 'Build mental strength alongside physical skill.', bg: 'Психическата сила върви заедно с техниката.' },
  'psy.t1.title': { en: 'Mental Preparation', bg: 'Подготовка за главата' },
  ...
  'psy.t2.desc': { en: 'Mentally rehearse programs, jumps, and competition scenarios.', bg: 'Мислено повтаряй програми, скокове и сценарии за състезание.' },
  'psy.t3.title': { en: 'Building Confidence', bg: 'Изграждане на увереност' },
  'psy.t3.desc': { en: 'Daily affirmations, small-win tracking, and structured reflection.', bg: 'Ежедневни афирмации, малки победи и редовни рефлексии.' },
  'psy.t4.title': { en: 'Competition Mindset', bg: 'Състезателна нагласа' },
  'psy.t4.desc': { en: 'Manage nerves, stay focused, and turn anxiety into energy.', bg: 'Управлявай нервите, дръж фокус, превърни напрежението в енергия.' },
  'psy.t5.title': { en: 'Emotional Resilience', bg: 'Емоционална устойчивост' },
  'psy.t5.desc': { en: 'Process frustration, bounce back from falls, and stay motivated.', bg: 'Изкарай разочарованието, ставай след падане, дръж мотивацията.' },
  'psy.t6.title': { en: 'Focus & Flow State', bg: 'Фокус и поток' },
  'psy.t6.desc': { en: 'Eliminate distractions and maintain deep concentration.', bg: 'Махни разсейването. Влез в дълбок фокус.' },
  'psy.cta.title': { en: 'Start building your mental game.', bg: 'Започни да градиш главата си.' },
  'psy.cta.subtitle': { en: 'All mental training tools are included free.', bg: 'Всички психо-инструменти са безплатни.' },
  ...
  'today.done.title': { en: 'You showed up today.', bg: 'Излезе днес.' },
  'today.done.subtitle': { en: 'That’s what builds a skater. Get some rest.', bg: 'Точно това гради фигурист. Сега почивай.' },
  ...
  'today.stage.grounding.desc': { en: 'A small gratitude, a body check, an honest read on how you feel.', bg: 'Малко благодарност, поглед към тялото, честен прочит на това как си.' },
  ...
  'dash.tab.mind': { en: 'Mind', bg: 'Глава' },
  ...
  'dash.mentalPrep.title': { en: 'Mental prep', bg: 'Подготовка на главата' },
  'dash.mentalPrep.subtitle': { en: 'Settle your head before you skate.', bg: 'Подреди главата преди лед.' },
  ...
  'dash.todayTraining.subtitle': { en: 'On-ice and off-ice, in one place.', bg: 'На лед и извън — на едно място.' },
  ...
  'dash.onIce.activities': { en: 'Edges, spins, footwork, programs', bg: 'Кантове, пирети, стъпки, програми' },
  ...
  'auth.placeholder.email': { en: 'you@example.com', bg: 'ti@example.com' },
  ...
  'dash.hero.poetic.b':   { en: 'Trust your edges.', bg: 'Довери се на кантовете си.' },
  ...
  'goalsX.cat.offIce':      { en: 'Off-Ice',                                bg: 'Извън леда' },
  ...
  'progressX.offIce':       { en: 'Off-Ice',            bg: 'Извън леда' },
