...
const dict: Dict = {
  ...
  'today.quick.type.label': { en: 'What kind of session?', bg: 'Какъв вид сесия?' },
  ...
  'today.quick.focus.label': { en: 'How focused were you?', bg: 'Колко фокусиран/а беше?' },
  'today.quick.focus.low': { en: 'Scattered', bg: 'Разсеян/а' },
  'today.quick.focus.high': { en: 'Locked in', bg: 'Напълно вътре' },
  'today.quick.mood.label': { en: 'Energy and mood', bg: 'Енергия и настроение' },
  'today.quick.wentWell.label': { en: 'What went well?', bg: 'Какво се получи?' },
  'today.quick.wentWell.placeholder': { en: 'A small win, a feeling, a moment…', bg: 'Малка победа, усещане, момент…' },
  'today.quick.needsWork.label': { en: 'What needs work?', bg: 'Над какво има да се работи?' },
  'today.quick.needsWork.placeholder': { en: 'A pattern, a skill, something to revisit…', bg: 'Модел, умение, нещо, към което да се върнеш…' },
  'today.quick.oneLine.label': { en: 'One sentence about today', bg: 'Едно изречение за днес' },
  'today.quick.oneLine.placeholder': { en: 'In a few words, what was today like?', bg: 'С няколко думи — какъв беше денят?' },
  'today.quick.save': { en: 'Save today', bg: 'Запази деня' },
  'today.quick.helper': { en: 'Fill in only what feels useful — partial entries are welcome.', bg: 'Попълни само това, което ти е полезно — частичните записи са добре дошли.' },
  'today.quick.saved.title': { en: "Today's logged. Well done.", bg: 'Денят е записан. Браво.' },
  'today.quick.saved.subtitle': { en: 'Come back tomorrow for the next entry, or open the deeper journal below.', bg: 'Върни се утре за следващия запис или отвори по-задълбочения дневник по-долу.' },
  'today.deeper.title': { en: 'Go deeper — guided journey & full journal', bg: 'По-задълбочено — направляван път и пълен дневник' },
