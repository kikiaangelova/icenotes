...
export const PHASEA_DICT: Record<string, { en: string; bg: string }> = {
  ...
  'a.today.next.log': {
    ...
    bg: 'След тренировка запиши сесията, докато детайлите са пресни.',
  },
  'a.today.next.reflect': {
    en: 'Note what worked, what was difficult, and the next focus.',
    bg: 'Отбележи какво се получи, какво затрудни работата и какъв е следващият фокус.',
  },
  'a.today.next.done': {
  ...
  'a.today.cta.logSub': { en: 'On ice or off ice · about one minute', bg: 'На лед или извън леда · около минута' },
  ...
  'a.today.cta.doneSub': { en: 'Log another session if you trained again', bg: 'Запиши още една сесия, ако си тренирал отново' },
  ...
  'a.tr.feel.good': { en: 'Solid', bg: 'Добра работа' },
  ...
  'a.tr.saveHint': { en: 'After saving, you can add a short reflection.', bg: 'След записа можеш да добавиш кратка рефлексия.' },
  ...
  // ── Reflection sheet ──
  'a.rf.title': { en: 'Post-training reflection', bg: 'Рефлексия след тренировка' },
  'a.rf.sub': {
    en: 'The session is saved. Set one clear focus for the next training.',
    bg: 'Сесията е записана. Задай един ясен фокус за следващата тренировка.',
  },
  'a.rf.worked': { en: 'What worked', bg: 'Какво се получи' },
  'a.rf.workedPh': { en: 'e.g. the flip entries stayed consistent', bg: 'напр. влизанията във флипа бяха постоянни' },
  'a.rf.hard': { en: 'What was difficult', bg: 'Какво беше трудно' },
  'a.rf.hardPh': { en: 'e.g. the axel became less consistent after the run-through', bg: 'напр. акселът стана по-несигурен след прокарването' },
  ...
  'a.sp.sub': {
    ...
    bg: 'Избери помощ за планиране или разговор по спортна психология.',
  },
